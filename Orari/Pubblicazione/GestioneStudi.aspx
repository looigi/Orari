<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="Orari.Master" CodeBehind="GestioneStudi.aspx.vb" Inherits="Orari.GestioneStudi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphCorpo" runat="server">
    ...
    <div class="mascheramodifica">
        <ul class="ul">
            <li class="li">
                <asp:Label ID="Label1" runat="server" Text="Scuola" CssClass ="etichettaTitolo"></asp:Label>
            </li>
            <li class="li">
                <asp:DropDownList ID="cmbScuole" runat="server" CssClass ="casellacombinata" OnSelectedIndexChanged ="SelezionaAbitazione" AutoPostBack ="true" ></asp:DropDownList>
            </li>
            <li class="liCentro">
            </li>
            <li class="li">
        ...
        <ul class="ul">
            <li class="li">
                <asp:Label ID="Label2" runat="server" Text="Nome Scuola" CssClass ="etichettaTitolo"></asp:Label>&nbsp;
            </li>
            <li class="li">
                <asp:TextBox ID="txtScuola" runat="server" CssClass ="casellatesto" text="" MaxLength="100" ></asp:TextBox>
           </li>
            <li class="li">
                <asp:Label ID="Label3" runat="server" Text="Indirizzo scuola" CssClass ="etichettaTitolo"></asp:Label>&nbsp;
...
<%--            <li class="li">
                <asp:Label ID="Label3" runat="server" Text="Km." CssClass ="etichettaTitolo"></asp:Label>
            </li>
            <li class="li">
                <asp:TextBox ID="txtKM" runat="server" CssClass ="casellatesto" text="" MaxLength="50"></asp:TextBox>
           </li>--%>
            <li class="li">

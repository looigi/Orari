<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="Orari.Master" CodeBehind="GestionePortate.aspx.vb" Inherits="Orari.GestionePortate" %>
...
<%--                <asp:ImageButton ID="imgAnnulla" runat="server" ImageUrl="App_Themes/Standard/Images/icona_INDIETRO.png" ToolTip ="Annulla" style="float: right; width: 50px;" />
            ...
            <li class="li">
                <asp:Label ID="Label3" runat="server" Text="Portata" CssClass ="etichettaTitolo"></asp:Label>
            </li>
            <li class="li">
                <asp:TextBox ID="txtPortata" runat="server" CssClass ="casellatesto" text="" MaxLength="40"></asp:TextBox>
            </li>
            <li class="li">
